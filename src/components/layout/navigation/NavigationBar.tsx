...
function Navigation() {
    return (
            <nav className="mx-auto p-7 flex xs:block xs:text-center sm:block sm:text-center md:block md:text-center bg-red-600">
                <Link to="/" className="uppercase font-semibold w-1/3 text-lg text-white cursor-pointer hover:text-black sm:mx-auto xs:text-base italic">Formula 1 Stats</Link> 
